...
export const TODO_LIST: TodoListProps[] = [
		...
		links: [
			{
				...
				url: `${import.meta.env.VITE_BASE_URL}auth`,
			},
		],
	},
	{
		...
		links: [
			...
			},
			{
				...
				url: `${import.meta.env.VITE_BASE_URL}list`,
			},
		],
	},
	{
	...
	{
		id: "be4f25322321181233423214b8-c9fe1231241d7fb7f9",
		ref: "19",
		title: "Login automático",
		description: (
			<>
				Quando um usuário logado tentar acessar o login, ele será redirecionado
				para a tela de extrato
			</>
		),
		status: "done",
		required: false,
	...
	{
		id: "be4f25322321181233423214b8-c9fe1231241d7fb7f0",
		ref: "20",
		title: "IBanking - Proteção de Rota",
		description: (
			<>
				Quando um usuário deslogado tentar acessar o extrato, ele será
